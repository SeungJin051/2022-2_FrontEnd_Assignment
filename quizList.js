let quizSet = {
  ...
  quiz: [
    {
      eng: "the study of computers and how they can be used",
    ...
    {
      eng: "But the distinction is crucial in computer science.",
      kor: "그러나 이 구별은 컴퓨터 과학에서 매우 중요하다.",
    },
    {
      eng: "What you need to know about cloud computing",
      kor: "빅데이터에 대해서 당신이 알아야 할 것들",
    },
    {
      eng: "a unit of computer information, consisting of 1024 megabytes",
    ...
    {
      eng: "This algorithm used the one-dimensional central section of the filter",
      kor: "이 알고리즘은 필터의 1차원 중앙 부분을 사용했다.",
    },
    {
    ...
    {
      eng: "the study of computers and their application",
      kor: "컴퓨터와 그 응용에 대한 연구",
    },
    {
      eng: "A Design and Implementation of English Word Learning Application",
